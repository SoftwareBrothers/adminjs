...
const translations = {
  ...
  messages: {
    ...
    thereWereValidationErrors:
      'Błędy walidacji - sprawdź poniżej',
    forbiddenError:
      'Nie masz uprawnień do akcji {{actionName}} na {{resourceId}}',
    anyForbiddenError: 'Nie masz uprawnień tej akcji.',
    successfullyCreated: 'Poprawnie utworzono nowy rekord',
    bulkDeleteError:
      'Wystąpiły błędy podczas usuwania rekordów. Przejrzyj wpisy w konsoli aby zobaczyć szczegóły.',
    errorFetchingRecords:
      'Wystąpiły błędy podczas pobierania danych. Przejrzyj wpisy w konsoli aby zobaczyć szczegóły.',
    errorFetchingRecord:
      'Wystąpiły błędy podczas pobierania rekordu. Przejrzyj wpisy w konsoli aby zobaczyć szczegóły.',
    ...
    pickSomeFirstToRemove:
      'Aby usunąć rekordy należy je najpierw wybrać',
    error404Resource: 'Nie można znaleźć zasobu o id: {{resourceId}}',
    error404Action:
      'Do zasobu o id: {{resourceId}} nie została przypisana akcja {{actionName}} lub nie masz uprawnień do jej użycia.',
    error404Record:
      'Zasób o id: {{resourceId}} nie zaiera rekordu o id: {{recordId}} lub nie masz do niego dostępu.',
    ...
    loginWelcome:
      'AdminJS - najlepszy admin framework dla aplikacji Node.js , oparty na React.',
    ...
    customizeResources_subtitle:
      'Definiowanie sposobu zachowania, dodawanie właściwości i więcej...',
    ...
    community_subtitle:
      'Wymieniaj informacje z twórcami AdminJS i innymi użytkownikami.',
    ...
    needMoreSolutions_subtitle:
      'Jesteśmy tutaj, aby dostarczyć Ci wpaniały projekt UX/UI i dostosować do Twoich potrzeb panel AdminJS',
