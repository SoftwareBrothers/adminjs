...
const translations = {
  ...
  messages: {
    ...
    loginWelcome: 'To AdminPanel - the best admin framework for Node.js apps, based on React.',
    ...
    writeOwnComponents_subtitle: 'How to modify the Look and Feel of AdminPanel',
    ...
    roleBasedAccess_subtitle: 'Create user roles and permissions in AdminPanel',
    community_title: 'Join the slack community',
    community_subtitle: 'Talk with the creators of AdminPanel and other AdminPanel users',
    ...
    needMoreSolutions_subtitle: 'We are here to provide you a beautiful UX/UI design and tailor made software based (not only) on AdminPanel',
