...
import { ValidationError, PropertyErrors, RecordError } from '@adminjs/common/errors'
...
describe('Record', function () {
  ...
  describe('#populate', function () {
    ...
    it('clears populated field when record is null or undefined', () => {
      ...
      }) as any // chai-change is not typed
      expectation.to.alter(() => record.populated.value, { from: 'something', to: undefined })
    })
  })
