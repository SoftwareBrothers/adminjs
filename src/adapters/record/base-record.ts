...
import { flat, GetOptions } from '@adminjs/common/utils'
import { ValidationError, RecordError, PropertyErrors } from '@adminjs/common/errors'
...
class BaseRecord {
  ...
  title(): string {
    ...
    return nameProperty ? this.get(nameProperty.name()) : this.id()
  }
