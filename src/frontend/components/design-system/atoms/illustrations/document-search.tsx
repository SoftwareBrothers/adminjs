...
export const DocumentSearch: React.FC<Props> = ({ width, height }) => {
  ...
  return (
    <svg width={svgWidth} height={svgHeight} viewBox="0 0 152 169" version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink">
      <g id="Symbols" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        <g id="Group" transform="translate(2.000000, 2.000000)" stroke="#879FFA" strokeWidth="3">
          ...
          <path d="M55,42.2162102 L55,54 C55,55.1045695 54.1045695,56 53,56 L41.1644979,56" id="Path" fill="#CBD5FD" />
          ...
          <circle id="Oval" fill="#CBD5FD" cx="76" cy="84" r="18" />
          <circle id="Oval-Copy-2" fill="#FFFFFF" cx="76" cy="84" r="10" />
          <rect id="Rectangle" fill="#CBD5FD" transform="translate(105.316743, 113.185977) rotate(-315.000000) translate(-105.316743, -113.185977) " x="91.8167434" y="108.685977" width="27" height="9" rx="2" />
