var AdminBro = (function (React, reactRedux, reactRouterDom, styled, PropTypes$1, axios, redux, reactDom) {
	...
	})(["display:flex;align-items:center;color:", ";font-weight:bold;"], ({
	  theme
	...
	})(["&&&{display:block;text-transform:uppercase;font-size:", ";color:", ";font-weight:normal;margin:0 0 ", " 0;letter-spacing:0.1em;}"], ({
	  theme
	}) => theme.fonts.min, ({
	  theme
	}) => theme.colors.lightText, ({
  ...
  theme
	...
	*/
	...
	})(["margin-bottom:", ";& input{border-radius:0;border-color:", ";box-shadow:none;&:focus{border-color:", ";}}"], ({
	  theme
	}) => theme.sizes.paddingLayout, ({
	  theme
	}) => theme.colors.border, ({
	...
	*/
	...
	class BasePropertyComponent extends React__default.Component {
	  ...
	  render() {
	    ...
	    return React__default.createElement(ErrorBoundary, null, React__default.createElement(PropertyRenderer, {
	      property: property,
	      resource: resource,
	      record: record,
	      filter: filter,
	...
	var constants_1$1 = constants$1.DOCS;
	...
	class BaseActionComponent extends React__default.Component {
	  ...
	  render() {
	    ...
	    const documentationLink = [constants_1$1, 'BaseAction.html'].join('/');
	...
	const ResourceAction = props => {
	  ...
	  return React__default.createElement("div", null, React__default.createElement(NoticeWrapper$2, null, React__default.createElement(Notice, null)), React__default.createElement(WrapperBox, null, React__default.createElement(Breadcrumbs, {
	    ...
	    resource: resource,
	    paths: paths
	  })), action.showFilter ? React__default.createElement(Filter$5, {
	    resource: resource,
	...
	const NoticeWrapper$3 = styled__default.div.withConfig({
	...
	class Resource extends React__default.Component {
	  ...
	  render() {
	    ...
	    return React__default.createElement(Wrapper, null, React__default.createElement(NoticeWrapper$3, null, React__default.createElement(Notice, null)), React__default.createElement(WrapperBox, null, React__default.createElement(Breadcrumbs, {
	      resource: resource
	    }), React__default.createElement(ActionHeader, {
	      resource: resource,
	      tag: total,
	      ...
	      border: true
	    }, loading ? React__default.createElement(Loader, null) : React__default.createElement(RecordsTable, {
