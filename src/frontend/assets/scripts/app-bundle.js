var AdminBro = (function (React, reactRedux, reactRouterDom, styled, PropTypes$1, axios, redux, reactDom) {
	...
	const propertyType = PropTypes$1.shape({
	...
	})(["display:flex;align-items:center;color:", ";font-weight:bold;"], colors.defaultText);
	...
	})(["color:", ";padding:", ";display:block;&:hover{color:", ";}&.active{color:", ";}"], colors.defaultText, sizes.paddingMin, colors.primary, colors.primary);
	...
	})(["background:", ";padding-left:", ";padding-right:", ";line-height:40px;border-radius:", ";display:flex;align-items:baseline;color:", ";position:relative;& > i,& > svg{margin-right:", ";color:", ";margin-right:", ";}"], colors.lightBck, sizes.padding, sizes.padding, sizes.paddingLayout, colors.defaultText, sizes.paddingMin, colors.lightText, sizes.padding);
	const ResourcesList = styled__default.ul.withConfig({
	  displayName: "sidebar-parent__ResourcesList",
	  componentId: "sc-3z92jk-1"
	})(["margin:", " 0;padding-left:40px;"], sizes.padding);
	...
	})(["font-size:", ";text-align:center;color:", ";& > svg,& > a{color:", ";margin:0 ", ";}"], fonts.min, colors.lightText, colors.love, sizes.paddingMin);

	const SidebarFooter = () => React__default.createElement(StyledFooter, null, "With", React__default.createElement("i", {
	...
	})(["display:flex;flex-shrink:0;flex-direction:column;justify-content:space-between;height:100%;overflow-y:auto;border-right:1px solid ", ";transition:width 0.5s;& > section{padding:", " ", " ", ";width:", ";}&.hidden{width:0px;transition:width 0.5s;overflow:hidden;& > section{opacity:0;}}"], colors.border, sizes.padding, sizes.paddingLayout, sizes.paddingLayout, sizes.sidebarWidth);
	const SidebarLabel = styled__default.h2.withConfig({
	  displayName: "sidebar__SidebarLabel",
	  componentId: "ah0hhb-1"
	})(["margin-top:", ";margin-left:", ";margin-bottom:", ";color:", ";font-size:", ";text-transform:uppercase;letter-spacing:.1em;"], sizes.padding, sizes.padding, sizes.padding, colors.lightText, fonts.min);
	...
	})(["padding-right:", ";border-radius:50px;margin:10px 0;img{border-radius:50%;margin-left:", ";&:after{display:none;}}"], sizes.padding, sizes.padding);
	...
	})(["&&&{padding:", " ", ";color:", ";&:hover{color:", ";}i,svg{margin-right:", ";}}"], sizes.padding, sizes.paddingLayout, colors.defaultText, colors.primary, sizes.padding);
	...
	})(["height:", ";border-bottom:1px solid ", ";padding:0 ", ";flex-shrink:0;"], sizes.navbarHeight, colors.border, sizes.paddingLayout);
	...
	})(["&&&{font-size:", ";border-radius:0;border-color:", ";background:#fff;height:32px;padding:", " ", ";color:", ";&:hover{border-color:", ";}&.is-primary{background-color:", ";color:#ffffff;&:hover{background-color:", ";}}&.is-text{background-color:transparent;color:", ";border:transparent;}&.in-dropdown{color:", ";font-size:", ";width:100%;text-align:start;justify-content:flex-start;height:40px;padding-left:40px;}}"], fonts.medium, colors.primary, sizes.paddingMin, sizes.padding, colors.primary, colors.primaryHover, colors.primary, colors.primaryHover, colors.primary, colors.defaultText, fonts.base);
	...
	const Svg = () => React__default.createElement("svg", {
	...
	})(["&&&{margin:-", " 0 ", " -10px;font-size:", ";}"], sizes.padding, sizes.padding, fonts.base);
	...
	})(["&&&{color:", ";&:hover{color:", ";}}"], colors.lightText, colors.primary);
	/**
	 * @private
	 * @component
	 * var recordAction = {
	...
	})(["&&&{background:", ";color:#fff;margin-left:", ";}"], colors.primary, sizes.padding);
	const BackBtn = styled__default(reactRouterDom.Link).withConfig({
	  displayName: "action-header__BackBtn",
	  componentId: "odgflh-2"
	})(["&&&{border-radius:50%;width:", ";height:", ";color:", ";font-size:", ";padding:", ";background-color:", ";text-align:center;margin-right:", ";&:hover{background-color:", ";color:#fff;}}"], sizes.paddingLayout, sizes.paddingLayout, colors.lightText, fonts.base, sizes.paddingMin, colors.superLightBack, sizes.padding, colors.lightText);
	const HeaderTitle = styled__default.h1.attrs({
	  className: 'level-left'
	}).withConfig({
	  displayName: "action-header__HeaderTitle",
	  componentId: "odgflh-3"
	})(["&&&{font-size:", ";font-weight:normal;}"], fonts.header);
	const HeaderButtons = styled__default.div.attrs({
	  className: 'level-right'
	}).withConfig({
	  displayName: "action-header__HeaderButtons",
	  componentId: "odgflh-4"
	})(["", "{margin-left:", ";}"], StyledButton, sizes.padding);
	/**
	 * Header of an action
	 *
	 * @private
	...
	const WrapperBox = styled__default.section.withConfig({
	  displayName: "wrapper-box__WrapperBox",
	  componentId: "liehve-0"
	})(["padding:", ";flex-grow:1;border:", ";background:", ";"], sizes.paddingLayout, props => props.border ? `1px solid ${colors.border}` : 'none', props => props.border ? '#ffffff' : 'transparent');
	...
	})(["&.success{background-color:", ";border:1px solid ", ";& .progressBar{background-color:", ";}}&.error{background-color:", ";border:1px solid ", ";& .delete:before,& .delete:after{background-color:", ";}& .progressBar{background-color:", ";}}& .delete{background:transparent;right:", ";top:", ";&:before,&:after{background-color:", ";}&:after{height:80%;width:1px;}&:before{width:80%;height:1px;}}& .progressBar{position:absolute;bottom:0;left:0;height:4px;background:#fff;transition:width 1s linear;}"], colors.lightSuccess, colors.success, colors.success, colors.lightError, colors.error, colors.error, colors.error, sizes.padding, sizes.padding, colors.success);
	...
	const NoticeBox = props => {
	  ...
	  return React__default.createElement(React__default.Fragment, null, notices && notices.map(notice => React__default.createElement(NoticeElement, {
	    key: notice.id,
	    notice: notice,
	    drop: () => drop(notice.id),
	...
	})(["&&&{display:block;text-transform:uppercase;font-size:", ";color:", ";font-weight:normal;margin:0 0 ", " 0;letter-spacing:0.1em;}"], fonts.min, colors.lightText, sizes.paddingMin);
	...
	*/
	...
	var CrossIcon = function CrossIcon(props) {
	  return React__default.createElement(Svg$1, _extends({
	    size: 20
	...
	})(["margin-bottom:", ";& input{border-radius:0;border-color:", ";box-shadow:none;&:focus{border-color:", ";}}"], sizes.paddingLayout, colors.border, colors.primary);
	/**
	 * @classdesc
	...
	})(["margin:", " 0;& input{border-radius:0;border-color:", ";box-shadow:none;background:transparent;color:", ";&:focus{border-color:", ";}}& .icon{opacity:0.25;}"], sizes.paddingLayout, colors.borderOnDark, colors.lightText, colors.primary);
	/**
	 * @classdesc
	...
	const filterStyles = {
	  control: (provided, state) => ({ ...provided,
	    border: state.isFocused ? `1px solid ${colors.primary}` : `1px solid ${colors.borderOnDark}`,
	    borderRadius: '0px',
	    background: 'transparent',
	...
	class Edit$1 extends React__default.PureComponent {
	  handleChange(event) {
	    const {
	      property,
	      onChange
	...
	class Show$1 extends React__default.PureComponent {
	  render() {
	    const {
	      property,
	      record
	...
	class Filter$2 extends React__default.Component {
	  constructor(props) {
	    super(props);
	    this.pickerRef = {
	...
	class Edit$3 extends React__default.Component {
	  constructor(props) {
	    super(props);
	...
	*/
	...
	class Filter$3 extends React__default.PureComponent {
	  handleChange(selected) {
	    const {
	      onChange,
	      property
	...
	class PropertyType extends React__default.Component {
	  constructor(props) {
	    super(props);
	    this.state = {
	      isClient: false
	  ...
	  render() {
	    ...
	    let PropertyRenderer = types$1[property.type] && types$1[property.type][where] || defaultType[where];
	...
	class New extends React__default.Component {
	  ...
	  render() {
	    ...
	    }, properties.map(property => React__default.createElement(PropertyType, {
	      key: property.name,
	      where: "edit",
	      property: property,
	      resource: resource,
	...
	const Loader = () => React__default.createElement("div", null, "Loading...");
	...
	class Show$5 extends React__default.Component {
	  constructor(props) {
	    super(props);
	    this.state = {
	      isLoading: true,
	...
	class RecordAction extends React__default.Component {
	  static actionComponent({
	    ...
	    return Action || (() => React__default.createElement("div", null));
	  }
	  ...
	  render() {
	    ...
	    const Action = RecordAction.actionComponent({
	      action,
	      isClient
	    });
	    return React__default.createElement(WrapperBox, null, React__default.createElement(Breadcrumbs, {
	      resource: resource,
	...
	class ResourceAction extends React__default.Component {
	  constructor(props) {
	    super(props);
	    this.state = {
	      isClient: false
	  ...
	  render() {
	    ...
	    Action = Action || (() => React__default.createElement("div", null));
	...
	})(["&&&{color:", ";padding:", ";border-color:", ";& a:not(.in-dropdown){color:", ";}&.main{font-weight:bold;}}"], colors.defaultText, sizes.padding, colors.border, colors.primary);
	const DropdownTrigger = styled__default.div.attrs({
	  className: 'dropdown-trigger'
	}).withConfig({
	  displayName: "record-in-list__DropdownTrigger",
	  componentId: "sc-12d52vn-1"
	})(["padding:0px ", ";font-size:20px;line-height:20px;&:hover{background:#fff;}"], sizes.padding);
	const DropdownMenu = styled__default.div.attrs({
	  className: 'dropdown-menu'
	}).withConfig({
	  displayName: "record-in-list__DropdownMenu",
	  componentId: "sc-12d52vn-2"
	...
	class RecordInList extends React__default.PureComponent {
	  render() {
	    ...
	    return React__default.createElement("tr", null, resource.listProperties.map(property => React__default.createElement(Td, {
	      ...
	      key: "options"
	    }, React__default.createElement(ActionsDropdown, null, recordActions.map(action => React__default.createElement(ActionButton$1, {
	      action: action,
	      key: action.name,
	      resourceId: resource.id,
	      recordId: record.id,
	...
	})(["&&&{font-size:", ";text-transform:uppercase;color:", ";font-weight:normal;padding:", ";letter-spacing:0.1em;border:none;}"], fonts.min, colors.lightText, sizes.padding);
	...
	})(["color:", ";&.active{color:", ";}& > i{margin-left:", "}"], colors.lightText, colors.primary, sizes.padding);
	...
	const Table = styled__default.table.attrs({
	  ...
	  displayName: "records-table__Table",
	  componentId: "sc-17vp4cq-0"
	})(["& > thead > tr > th{border:none;&.actions{width:80px;}}"]);
	...
	const RecordsTable = props => {
	  ...
	  return React__default.createElement(Table, null, React__default.createElement("thead", null, React__default.createElement("tr", {
	    key: "header"
	  }, resource.listProperties.map(property => React__default.createElement(PropertyHeader$1, {
	    resource: resource,
	    property: property,
	    key: property.name
	...
	})(["& > .pagination{border:1px solid ", ";padding:4px;}"], colors.border);
	...
	})(["background:", ";flex-shrink:0;width:", ";color:#fff;padding-top:60px;transition:width 0.5s;position:absolute;top:0;right:0;bottom:0;overflow-x:hidden;overflow-y:scroll;&.filter-hidden{width:0;transition:width 0.5s;}"], colors.darkBck, sizes.sidebarWidth);
	const FilterLink = styled__default.a.withConfig({
	  displayName: "filter__FilterLink",
	  componentId: "mowuhm-1"
	})(["color:#fff;& > span{opacity:0.25;color:", ";border:1px solid ", ";border-radius:3px;padding:8px 10px;margin-right:", ";}&:hover{color:", ";& span{color:", ";border-color:", ";opacity:1;}}"], colors.lightText, colors.lightText, sizes.padding, colors.primary, colors.primary, colors.primary);
	const FilterContent = styled__default.section.withConfig({
	  displayName: "filter__FilterContent",
	  componentId: "mowuhm-2"
	})(["padding:", ";width:", ";overflow:hidden;& ", "{margin:", " 0;width:100%;}"], sizes.paddingLayout, sizes.sidebarWidth, StyledButton, sizes.paddingMin);
	...
	class Resource extends React__default.Component {
	  constructor(props) {
	    super(props);
	    const {
	      location
	  ...
	  render() {
	    ...
	    return React__default.createElement(Wrapper, null, React__default.createElement(WrapperBox, null, React__default.createElement(Breadcrumbs, {
	      resource: resource
	    }), React__default.createElement(Notice, null), React__default.createElement(ActionHeader, {
	      resource: resource,
	      tag: total,
	    ...
	    }), React__default.createElement(WrapperBox, {
	      border: true
...
`;
	 ...
	 * @component
	 * props = {
	 *   children: 'some content inside a column'
	 * }
	 */

	const Column = styled__default.section.attrs(({
	  width = 4,
	  offset = 0
	}) => ({
	...
	const Columns = styled__default.section.attrs({
	  className: 'columns is-multiline'
	}).withConfig({
	  displayName: "columns__Columns",
	  componentId: "sc-97bm1x-0"
	})([""]);

	const Wrapper$1 = styled__default.section.attrs({
	  className: 'content'
	}).withConfig({
	  displayName: "dashboard-header__Wrapper",
	  componentId: "pokiey-0"
	})(["&&{padding:", ";background:", ";color:#fff;margin-bottom:0;& > *{color:#fff;}& > h1{font-size:53px;margin-bottom:2px;}}"], sizes.paddingLayout, colors.superDarkBck);
	...
	class ValueBlock extends React__default.PureComponent {
	  render() {
	    ...
	    return React__default.createElement(WrapperBox, {
	      border: true
	    }, children, React__default.createElement(Level, {
	      color: color
	    }, React__default.createElement("div", {
	      className: "value"
