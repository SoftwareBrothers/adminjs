var AdminBro = (function (React, reactRedux, reactRouterDom, styled, PropTypes$1, axios, redux, reactDom) {
  ...
  theme
	...
	*/
	...
	const { unflatten: unflatten$1, flatten: flatten$1 } = flat;
	...
	class Filter$2 {
	  ...
	  static normalizeKeys(filters) {
	    return unflatten$1(flatten$1(filters), { delimiter: Filter$2.PARAM_SEPARATOR })
	  }
	...
	*/
	...
	const convertParamsToArrayItems = (property, record) => {
	  ...
	  return unflatten$2(obj)[property.name] || [];
	};
	...
	class Edit$5 extends React__default.Component {
	  ...
	  removeItem(i) {
	    ...
	    newRecord.params = flatten$2({ ...unflatten$3(newRecord.params),
	...
	class List$5 extends React__default.PureComponent {
	  render() {
	    ...
	    const showAction = resource.recordActions.find(a => a.name === 'show');
	    const values = unflatten$4(record.params)[property.name] || [];
	...
	var EditAction = withNotice(reactRouterDom.withRouter(Edit$7));
	...
	var ListAction = withNotice(reactRouterDom.withRouter(List$7));
