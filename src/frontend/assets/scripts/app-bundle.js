var AdminBro = (function (React, reactRedux, reactRouterDom, styled, PropTypes$1, axios, redux, reactDom) {
	...
	})(["&&&{font-size:", ";border-radius:0;border-color:", ";background:#fff;height:32px;padding:", " ", ";color:", ";& i,& svg{margin-right:5px;}&:hover{border-color:", ";}&.is-primary{background-color:", ";color:#ffffff;&:hover{background-color:", ";}}&.is-text{background-color:transparent;color:", ";border:transparent;}&.in-dropdown{color:", ";font-size:", ";width:100%;text-align:start;justify-content:flex-start;height:40px;padding-left:40px;border:none;&:hover{border:4px ", ";padding-left:36px;border-style:none solid;}}}"], fonts.medium, colors.primary, sizes.paddingMin, sizes.padding, colors.primary, colors.primaryHover, colors.primary, colors.primaryHover, colors.primary, colors.defaultText, fonts.base, colors.primary);
	/**
	 * @classdesc
	...
	})(["padding:", ";flex-grow:1;border:", ";background:", ";& > h1{font-size:22px;margin-top:", ";margin-bottom:", ";}"], sizes.paddingLayout, props => props.border ? `1px solid ${colors.border}` : 'none', props => props.border ? '#ffffff' : 'transparent', sizes.padding, sizes.padding);
	/**
	 * @classdesc
	...
	*/
	...
	class BaseActionComponent extends React__default.Component {
	  ...
	  render() {
	    ...
	    return Action || React__default.createElement(WrapperBox, null, "You have to implement action component for your Action.");
	  }
	...
	})(["&&&{color:", ";& a:not(.in-dropdown){color:", ";}&.main{font-weight:bold;}}"], colors.defaultText, colors.primary);
	...
	})(["& > thead > tr > th{border:none;}td{color:", ";padding:", ";border-color:", ";}"], colors.defaultText, sizes.padding, colors.border);
	/**
	 * @classdesc
...
`;
	...
	})(["&&{padding:90px ", ";background:", ";color:#fff;margin-bottom:0;& > *{color:#fff;}p{color:#fff;}h1{color:#fff;font-size:53px;margin-bottom:4px;}}"], sizes.paddingLayout, colors.superDarkBck);
	/**
	 * @classdesc
	...
	})(["position:absolute;top:0;left:0;width:100%;height:100%;display:block;transition:border-width 0.2s;&:hover{transition:border-width 0.2s;border-bottom:5px solid ", ";}"], colors.primary);
