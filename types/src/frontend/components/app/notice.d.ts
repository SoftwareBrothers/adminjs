...
declare const ConnectedNoticeBox: import("react-redux").ConnectedComponent<React.FC<NoticeBoxPropsFromState & NoticeBoxDispatchFromState>, Omit<NoticeBoxPropsFromState & NoticeBoxDispatchFromState, "notices" | "drop" | "notifyProgress"> & import("react-redux").ConnectProps>;
